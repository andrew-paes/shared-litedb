...
namespace LiteDB
{
    ...
    public partial class LiteDatabase : IDisposable
    {
        ...
        /// </summary>
        public BsonMapper Mapper { get; private set; } = BsonMapper.Global;
        ...
        public LiteDatabase(IDiskService diskService, BsonMapper mapper = null, string password = null, TimeSpan? timeout = null, int cacheSize = 5000, Logger log = null)
        {
            ...
            _engine = new LazyLoad<LiteEngine>(() => new LiteEngine(diskService, password: password, timeout: timeout, cacheSize: cacheSize, log: Log ));
        }
        ...
        {
            return new LiteCollection<T>(name, _engine, Mapper, Log);
        }
        ...
        public LiteCollection<BsonDocument> GetCollection(string name)
        {
            ...
            return new LiteCollection<BsonDocument>(name, _engine, Mapper, Log);
        }
