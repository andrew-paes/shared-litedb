...
namespace LiteDB
{
    public partial class LiteCollection<T>
    {
        ...
        public int Count()
        {
            ...
            return (int)_engine.Value.Count(Name, null);
        }
        ...
        public int Count(Query query)
        {
            ...
            return (int)_engine.Value.Count(Name, query);
        }
        ...
        public int Count(Expression<Func<T, bool>> predicate)
        {
            ...
            return this.Count(Visitor.Visit(predicate));
        }
        ...
        {
            // do not use indexes - collections has DocumentCount property
            return _engine.Value.Count(Name, null);
        }
        ...
        public long LongCount(Query query)
        {
            ...
            return _engine.Value.Count(Name, query);
        }
        ...
        public long LongCount(Expression<Func<T, bool>> predicate)
        {
            ...
            return this.LongCount(Visitor.Visit(predicate));
        }
        ...
        public bool Exists(Query query)
        {
            ...
            return _engine.Value.Exists(Name, query);
        }
        ...
        public bool Exists(Expression<Func<T, bool>> predicate)
        {
            ...
            return this.Exists(Visitor.Visit(predicate));
        }
        ...
        public BsonValue Min(string field)
        {
            ...
            return _engine.Value.Min(Name, field);
        }
        ...
        public BsonValue Min<K>(Expression<Func<T, K>> property)
        {
            ...
            var field = Visitor.GetField(property);
        ...
        public BsonValue Max(string field)
        {
            ...
            return _engine.Value.Max(Name, field);
        }
