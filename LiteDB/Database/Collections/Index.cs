...
namespace LiteDB
{
    public partial class LiteCollection<T>
    {
        ...
        public bool EnsureIndex(string field, string expression, bool unique = false)
        {
            ...
            return _engine.Value.EnsureIndex(Name, field, expression, unique);
        }
        ...
        public bool EnsureIndex<K>(Expression<Func<T, K>> property, string expression, bool unique = false)
        {
            ...
            return this.EnsureIndex(field, expression ?? Visitor.GetPath(property), unique);
        }
        ...
        {
            return _engine.Value.GetIndexes(Name);
        }
        ...
        {
            return _engine.Value.DropIndex(Name, field);
        }
    }
}