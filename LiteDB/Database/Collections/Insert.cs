...
namespace LiteDB
{
    public partial class LiteCollection<T>
    {
        ...
        public BsonValue Insert(T document)
        {
            ...
            var id = _engine.Value.Insert(Name, doc, _autoId);
        ...
        public int Insert(IEnumerable<T> docs)
        {
            ...
            return _engine.Value.Insert(Name, this.GetBsonDocs(docs), _autoId);
        }
        ...
        public int InsertBulk(IEnumerable<T> docs, int batchSize = 5000)
        {
            ...
            return _engine.Value.InsertBulk(Name, this.GetBsonDocs(docs), batchSize, _autoId);
        }
